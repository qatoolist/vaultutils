...
class Config:
    ...
    NETWORK_NEGOTIATE_AUTH_TRUSTED_URIS = os.getenv("NETWORK_NEGOTIATE_AUTH_TRUSTED_URIS", ".myorg.com")
    NETWORK_NEGOTIATE_AUTH_DELEGATION_URIS = os.getenv("NETWORK_NEGOTIATE_AUTH_DELEGATION_URIS", ".myorg.com")
    ...
    def get_auth_method(cls):
        ...
        if cls.VAULT_TOKEN:
            ...
            raise ValueError("No valid authentication method found. Please set the appropriate environment variables.")
